...
<c:if test="${empty listContracts}">
    Нет контрактов<br>
    <form:form action="person/${person.id}/addContract" commandName="person">
        <table>
            <tr>
                <td>
            ...
            <tr>
                ...
                <%--Выпадающий список с тарифами или таблица--%>
            <table class="tg">
                <tr>
                    <th width="80">ID</th>
                    <th width="120">name</th>
                </tr>
                <c:forEach items="${tariffSet}" var="tariff">
                    <tr>
                        <td>${tariff.id}</td>
                        <td>${tariff.password}</td>
                    </tr>
                </c:forEach>
            </table>

            <form:select path="${tariff}" name="tariff" cssClass="form-control">
                <form:option value="NONE" label="--- Select ---"/>
                <form:options items="${tariffSet}}"/>
            </form:select>
        </table>
    </form:form>
