...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-offset-3 col-md-6">
            <spring:form class="form-horizontal" method="post" action="check-manager" modelAttribute="manager">
                <span class="heading">АВТОРИЗАЦИЯ МЕНЕДЖЕРА</span>
                <div class="form-group">
                    <spring:input path="id" type="login" class="form-control" id="inputLogin" placeholder="Login"/>
                    <i class="fa fa-user"></i>
                </div>
                <div class="form-group help">
                    <spring:input path="password" type="password" class="form-control" id="inputPassword" placeholder="Password"/>
